...
# ============================================
    ...
    li gp, 0x0000FF00      # Bolita (verde neón)
...
# ============================================
    ...
    li tp, 1               # Dirección horizontal (1 = derecha, -1 = izquierda)
    li a6, 1               # Dirección vertical (1 = abajo, -1 = arriba)
    mv a6, a6             # Guardamos la dirección vertical en a6
    mv tp,tp
...
# ACTUALIZAR POSICIÓN
# ============================================
    add s9, s9, tp         # columna += dir_x
    add s10, s10, a6       # fila += dir_y

# ============================================
# REBOTES EN BORDES
# ============================================
    # Rebotar en bordes izquierdo o derecho
    li  a7, 0
    blt s9,  a7, cambiar_dir_x
    li  a7, 34
    bgt s9,  a7, cambiar_dir_x

 # Rebotar en bordes superior o inferior
    li  a7, 0
...
continuar: 
# ============================================
# CALCULAR DIRECCIÓN Y ENCENDER NUEVA LED
# ============================================
    mul  a7, s10, a1
    add  a7,  a7, s9
    slli  a7,  a7, 2
...
dibujo_p2:
    ...
    blt t6, s6, dibujo_p2 
# ============================================
# CALCULAR DIRECCIÓN Y APAGAR LED ANTERIOR
# ============================================
    # Obtener dirección de la LED actual
    mul  a7, s10, a1        # fila * ancho
    add  a7,  a7, s9         # + columna
    slli  a7,  a7, 2         # *4 (bytes)
    add ra, a0,  a7         # dirección absoluta
    sw s0, 0 ra           # apagar LED anterior (negro)
  
  j loop

# ============================================
# CAMBIO DE DIRECCIÓN X (columna)
# ============================================
cambiar_dir_x:
    neg tp, tp
    mv tp,tp
